...
/***/ function(module, exports) {
	...
	function moveSlider() {
		...
		thumb.onmousedown = function (eventDown) {
			...
			console.log(Math.ceil(thumbBox.width / 2));
			...
			document.onmouseup = function (eventUp) {
				...
				if (pos < 0) {
					...
					thumb.style.left = sliderBox.width - Math.floor(thumbBox.width / 2) + 'px';
				} else {
					var stop = 0;
					...
					thumb.style.left = stop - Math.ceil(thumbBox.width / 2) + 'px';
				}
...
//# sourceMappingURL=0.bbca1a5aa8eb99455f5c.hot-update.js.map