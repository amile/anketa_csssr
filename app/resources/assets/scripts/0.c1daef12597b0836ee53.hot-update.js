...
/***/ function(module, exports) {
	...
	thumb.addEventListener('touchstart', function (eventDown) {
		...
		touchSlider.upHandler = function (eventUp) {
			document.removeEventListener('mousemove', touchSlider.moveHandler, false);
			var pos = eventUp.pageX - touchSlider.sliderBox.left;
			touchSlider.stopThumb(pos);
		};
		document.addEventListener('mousemove', touchSlider.moveHandler, false);
		document.addEventListener('mouseup', touchSlider.upHandler, false);
	}, { passive: false });

/***/ }

})
//# sourceMappingURL=0.c1daef12597b0836ee53.hot-update.js.map