...
/***/ function(module, exports) {
	...
	function MouseSlider() {
		...
		this.mouseUpHandler = function (eventUp) {
			document.removeEventListener('mousemove', MouseSlider.prototype.mouseMoveHandler, false);
		...
		this.mouseHandler = function (eventDown) {
			...
			document.addEventListener('mousemove', MouseSlider.prototype.mouseMoveHandler, false);
			document.addEventListener('mouseup', MouseSlider.prototype.mouseUpHandler, false);
		};
	}
	function handler() {
		thumb.addEventListener('mousedown', function (eventDown) {
			var slider = new MouseSlider();
			console.log(slider.mouseMoveHandler(eventDown));
		}, false);
...
//# sourceMappingURL=0.84f10bef8600fa5837a9.hot-update.js.map