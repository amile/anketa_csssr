...
/***/ function(module, exports, __webpack_require__) {
	...
	TouchSlider.prototype.moveHandler = function (eventMove) {
		if (eventMove.target.className === 'slider__thumb') {
			var _targetX = eventMove.targetTouches[0].pageX;
			this.moveThumb(_targetX);
		}
	};
	TouchSlider.prototype.upHandler = function (eventUp) {
		if (eventUp.target.className === 'slider__thumb') {
			document.removeEventListener('touchmove', TouchSlider.prototype.moveHandler, false);
	...
	TouchSlider.handler = function () {
		this.thumb.addEventListener('touchstart', function (eventDown) {
			...
			document.addEventListener('touchmove', TouchSlider.prototype.moveHandler, false);
			document.addEventListener('touchend', TouchSlider.prototype.upHandler, false);
	...
	MouseSlider.prototype.moveHandler = function () {
		Slider.prototype.moveThumb.apply(this, deltaX, targetX);
	};
	MouseSlider.prototype.upHandler = function (eventUp) {
		clearSelection();
		document.removeEventListener('mousemove', MouseSlider.prototype.moveHandler, false);
		var pos = eventUp.pageX - this.sliderBox.left;
		Slider.prototype.stopThumb.call(this, pos);
	};
	MouseSlider.prototype.handler = function () {
		this.thumb.addEventListener('mousedown', function (eventDown) {
			...
			document.addEventListener('mousemove', function (eventMove) {
				...
				MouseSlider.prototype.moveHandler.apply(this, deltaX, targetX);
			}, false);
			document.addEventListener('mouseup', MouseSlider.prototype.upHandler, false);
		}, false);
	};
...
//# sourceMappingURL=0.41f332f202eb44c7acd1.hot-update.js.map