...
/***/ function(module, exports) {
	...
	function MouseSlider() {
		Slider.apply(this);
		var moveHandler = function moveHandler(eventMove, deltaX) {
			var targetX = eventMove.pageX;
			this.moveThumb(targetX, deltaX);
		};
		var upHandler = function upHandler(eventUp) {
			clearSelection();
		...
		this.handler = function () {
			this.thumb.addEventListener('mousedown', function (eventDown) {
				...
				document.addEventListener('mousemove', moveHandler(deltaX), false);
...
//# sourceMappingURL=0.fdaaac6402796387c465.hot-update.js.map